# Obfuscating hardcoded keys

![iOS](https://img.shields.io/badge/platform-iOS-blue)

Obfuscation is a technique that allows to make the source or machine code difficult for humans to understand.
As a security measure, we might want to make api keys, tokens, secrets that are stored in the app bundle harder to read by a possible attacker who could extract the source code.
...
```swift
let verySecretKey = "V".e.r.y.space.s.e.c.r.e.t.space.k.e.y
```
